...
#ifndef USS_CONFIG_USSMETERVFRFLOWTEMPERATURECALIB_H_
#define USS_CONFIG_USSMETERVFRFLOWTEMPERATURECALIB_H_
//#############################################################################
//
//! \file   USS_meterVFRCalibFlowTemperature.h
//!
//! \brief  USS SW Library Meter VFR Calibration values using flow and temperature
//!
//
//  Group:          MSP
...
#define USS_METER_VFR_CALIB_FLOW_TEMPERATURE_NUM_FLOW          7
#define USS_METER_VFR_CALIB_FLOW_TEMPERATURE_NUM_TEMP          3
#define USS_METER_VFR_CALIB_FLOW_TEMPERATURE_POINT_LENGTH      21
#define USS_METER_VFR_CALIB_FLOW_TEMPERATURE_MC_LENGTH         12

//******************************************************************************
// The following table has quadrilateral points (volume flow rate, temperature).
// Volume Flow Rate in x-axis, and temperature in y-axis. The array 
// starts  at the top left (lowest flow, highest temperature), then traverses 
// left to right, then go to the next temperature below.
// For example 3 flows (F1, F2, F3), and 3 temperatures (T1, T2, T3) 
// where F3>F2>F1, and T3>T2>T1. The table's content is :
// (F1,T3), (F2,T3), (F3,T3) (F1,T2), (F2,T2), (F3,T2), (F1,T1) ,(F2,T1) and
// (F3,T1).
// F1,T3-----F2,T3------F3,T3
// |           |          |
// |           |          |
...
//
//******************************************************************************
#define USS_METER_VFR_CALIB_FLOW_TEMPERATURE_QUAD_POINTS                       \
{                                                                              \
    {                                                                          \
    ...
    {                                                                          \
        .iq16Flow = _IQ16(20.748562/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16Temp = _IQ16(50.90),                                              \
    },                                                                         \
    {                                                                          \
        .iq16Flow = _IQ16(48.880959/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16Temp = _IQ16(53.30),                                              \
    },                                                                         \
    {                                                                          \
        .iq16Flow = _IQ16(89.853775/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16Temp = _IQ16(54.20),                                              \
    },                                                                         \
    {                                                                          \
        .iq16Flow = _IQ16(204.438728/USS_VFR_LARGE_PIPE_ADDL_SF),              \
        .iq16Temp = _IQ16(54.90),                                              \
    },                                                                         \
    {                                                                          \
        .iq16Flow = _IQ16(342.572358/USS_VFR_LARGE_PIPE_ADDL_SF),              \
        .iq16Temp = _IQ16(55.10),                                              \
    },                                                                         \
    {                                                                          \
        .iq16Flow = _IQ16(775.691290/USS_VFR_LARGE_PIPE_ADDL_SF),              \
        .iq16Temp = _IQ16(54.80),                                              \
    },                                                                         \
    {                                                                          \
        .iq16Flow = _IQ16(8.133045/USS_VFR_LARGE_PIPE_ADDL_SF),                \
        .iq16Temp = _IQ16(22.90),                                              \
    },                                                                         \
    {                                                                          \
        .iq16Flow = _IQ16(22.647038/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16Temp = _IQ16(22.70),                                              \
    },                                                                         \
    {                                                                          \
        .iq16Flow = _IQ16(50.936890/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16Temp = _IQ16(22.50),                                              \
    },                                                                         \
    {                                                                          \
        .iq16Flow = _IQ16(94.444285/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16Temp = _IQ16(22.50),                                              \
    },                                                                         \
    {                                                                          \
        .iq16Flow = _IQ16(207.979079/USS_VFR_LARGE_PIPE_ADDL_SF),              \
        .iq16Temp = _IQ16(22.10),                                              \
    },                                                                         \
    {                                                                          \
        .iq16Flow = _IQ16(367.503307/USS_VFR_LARGE_PIPE_ADDL_SF),              \
        .iq16Temp = _IQ16(22.00),                                              \
    },                                                                         \
    {                                                                          \
        .iq16Flow = _IQ16(793.775274/USS_VFR_LARGE_PIPE_ADDL_SF),              \
        .iq16Temp = _IQ16(21.90),                                              \
    },                                                                         \
    {                                                                          \
        .iq16Flow = _IQ16(7.385140/USS_VFR_LARGE_PIPE_ADDL_SF),                \
        .iq16Temp = _IQ16(14.10),                                              \
    },                                                                         \
    {                                                                          \
        .iq16Flow = _IQ16(23.379610/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16Temp = _IQ16(14.00),                                              \
    },                                                                         \
    {                                                                          \
        .iq16Flow = _IQ16(48.972728/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16Temp = _IQ16(13.00),                                              \
    },                                                                         \
    {                                                                          \
        .iq16Flow = _IQ16(92.168026/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16Temp = _IQ16(13.00),                                              \
    },                                                                         \
    {                                                                          \
        .iq16Flow = _IQ16(195.986764/USS_VFR_LARGE_PIPE_ADDL_SF),              \
        .iq16Temp = _IQ16(12.60),                                              \
    },                                                                         \
    {                                                                          \
        .iq16Flow = _IQ16(371.647009/USS_VFR_LARGE_PIPE_ADDL_SF),              \
        .iq16Temp = _IQ16(12.20),                                              \
    },                                                                         \
    {                                                                          \
        .iq16Flow = _IQ16(800.608160/USS_VFR_LARGE_PIPE_ADDL_SF),              \
        .iq16Temp = _IQ16(13.40),                                              \
    },                                                                         \
}

//******************************************************************************
// The following table has meter constants for volume flow rate ,
// temperature quadrilaterals. The quadrilaterals have 4 vertices of quad points.
// The meter constants start from the top left , then traverses left to right, 
// then goes to next line below.
// For example 3 flows (F1, F2, F3), and 3 temperatures (T1, T2, T3) 
// where F3>F2>F1, and T3>T2>T1. There are (3-1) * (3-1) = 4 quadrilaterals.
...
//
//******************************************************************************
#define USS_METER_VFR_CALIB_FLOW_TEMPERATURE_METER_CONSTANTS                   \
{                                                                              \
    /* M0 */                                                                   \
    {                                                                          \
        .iq16M0 = _IQ16(-3.293588e0/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16M1 = _IQ16(8.731789e-1),                                          \
        .iq16M2 = _IQ16(9.186968e-2/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16M3 = _IQ16(-4.356838e-4),                                         \
    },                                                                         \
    /* M1 */                                                                   \
    {                                                                          \
        .iq16M0 = _IQ16(-6.429634e0/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16M1 = _IQ16(1.002555e0),                                           \
        .iq16M2 = _IQ16(9.851445e-2/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16M3 = _IQ16(-3.282439e-4),                                         \
    },                                                                         \
    /* M2 */                                                                   \
    {                                                                          \
        .iq16M0 = _IQ16(-5.227173e0/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16M1 = _IQ16(9.781822e-1),                                          \
        .iq16M2 = _IQ16(5.214404e-2/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16M3 = _IQ16(6.161296e-4),                                          \
    },                                                                         \
    /* M3 */                                                                   \
    {                                                                          \
        .iq16M0 = _IQ16(-1.121625e1/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16M1 = _IQ16(1.045461e0),                                           \
        .iq16M2 = _IQ16(3.48358e-1/USS_VFR_LARGE_PIPE_ADDL_SF),                \
        .iq16M3 = _IQ16(-2.692024e-3),                                         \
    },                                                                         \
    /* M4 */                                                                   \
    {                                                                          \
        .iq16M0 = _IQ16(1.393819e1/USS_VFR_LARGE_PIPE_ADDL_SF),                \
        .iq16M1 = _IQ16(9.219664e-1),                                          \
        .iq16M2 = _IQ16(-9.368729e-1/USS_VFR_LARGE_PIPE_ADDL_SF),              \
        .iq16M3 = _IQ16(3.602856e-3),                                          \
    },                                                                         \
    /* M5 */                                                                   \
    {                                                                          \
        .iq16M0 = _IQ16(-1.644428e1/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16M1 = _IQ16(1.00788e0),                                            \
        .iq16M2 = _IQ16(6.144982e-2/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16M3 = _IQ16(7.390311e-4),                                          \
    },                                                                         \
    /* M6 */                                                                   \
    {                                                                          \
        .iq16M0 = _IQ16(1.739691e-1/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16M1 = _IQ16(7.72509e-1),                                           \
        .iq16M2 = _IQ16(-5.929597e-2/USS_VFR_LARGE_PIPE_ADDL_SF),              \
        .iq16M3 = _IQ16(3.928895e-3),                                          \
    },                                                                         \
    /* M7 */                                                                   \
    {                                                                          \
        .iq16M0 = _IQ16(-3.444939e0/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16M1 = _IQ16(9.205525e-1),                                          \
        .iq16M2 = _IQ16(-3.334365e-2/USS_VFR_LARGE_PIPE_ADDL_SF),              \
        .iq16M3 = _IQ16(3.300686e-3),                                          \
    },                                                                         \
    /* M8 */                                                                   \
    {                                                                          \
        .iq16M0 = _IQ16(-8.626125e0/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16M1 = _IQ16(1.026198e0),                                           \
        .iq16M2 = _IQ16(2.032086e-1/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16M3 = _IQ16(-1.517893e-3),                                         \
    },                                                                         \
    /* M9 */                                                                   \
    {                                                                          \
        .iq16M0 = _IQ16(-2.595461e1/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16M1 = _IQ16(1.213856e0),                                           \
        .iq16M2 = _IQ16(1.01697e0/USS_VFR_LARGE_PIPE_ADDL_SF),                 \
        .iq16M3 = _IQ16(-1.031999e-2),                                         \
    },                                                                         \
    /* M10 */                                                                  \
    {                                                                          \
        .iq16M0 = _IQ16(4.785149e1/USS_VFR_LARGE_PIPE_ADDL_SF),                \
        .iq16M1 = _IQ16(8.385443e-1),                                          \
        .iq16M2 = _IQ16(-2.470538e0/USS_VFR_LARGE_PIPE_ADDL_SF),               \
        .iq16M3 = _IQ16(7.373414e-3),                                          \
    },                                                                         \
    /* M11 */                                                                  \
    {                                                                          \
        .iq16M0 = _IQ16(-1.34306e1/USS_VFR_LARGE_PIPE_ADDL_SF),                \
        .iq16M1 = _IQ16(1.003113e0),                                           \
        .iq16M2 = _IQ16(-7.567322e-2/USS_VFR_LARGE_PIPE_ADDL_SF),              \
        .iq16M3 = _IQ16(9.56099e-4),                                           \
    },                                                                         \
}

#endif /* USS_CONFIG_USSMETERVFRFLOWTEMPERATURECALIB_H_ */
